...
class SedanTest {
    ...
    void constructorWithWrongParametersShouldThrowException(String brand, String model, Year manufactureYear, double trunkCapacity){
        ...
        assertDoesNotThrow(()-> new Sedan("OkBrand", "OkModel", FuelType.GASOLINE, Year.of(2022), 702.98, CarType.SEDAN));
    }

    @Test
    void testToStringShouldReturnExpectedString() {
        Sedan testSedan01 = new Sedan("TestBrand", "TestModel", FuelType.ELECTRIC, Year.of(2025), 818.71, CarType.SEDAN);
    ...
    void getDescriptionShouldReturnExpectedString() {
        ...
        Sedan testSedan02 = new Sedan("TestBrand", "TestModel", FuelType.ELECTRIC, Year.of(2025), 818.71, CarType.SEDAN);
